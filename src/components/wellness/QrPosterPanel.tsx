            ...
            {isLoading || !settings ? (
              ...
              >
                ...
                <div className="space-y-1 text-sm text-muted-foreground">
                  <p>Open your phone camera, scan the code, sign in once — your visit is sent for approval.</p>
                  <p lang="hi">फ़ोन कैमरे से कोड स्कैन करें — मंज़ूरी के बाद उपस्थिति दर्ज हो जाएगी।</p>
                </div>
              </div>
            )}
          </CardContent>
