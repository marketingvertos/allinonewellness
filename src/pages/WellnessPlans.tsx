...
import { useSaveWellnessPlan, useWellnessPlans, WellnessPlan } from "@/hooks/useWellness";
    ...
    <div className="space-y-6">
      ...
      {isLoading ? (
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {plans.map((p) => (
            <Card key={p.id} className="cursor-pointer transition-colors hover:bg-accent/50" onClick={() => openEdit(p)}>
              ...
              <CardContent className="space-y-1 text-sm text-muted-foreground">
                ...
                <p>{p.duration_days} days · {p.total_servings} servings</p>
        ...
        <DialogContent>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <div className="space-y-2">
              ...
              <Input id="p-days" inputMode="numeric" value={form.duration_days} onChange={(e) => setForm({ ...form, duration_days: e.target.value })} />
            </div>
            <div className="space-y-2">
              <Label htmlFor="p-servings">Total servings</Label>
              <Input id="p-servings" inputMode="numeric" value={form.total_servings} onChange={(e) => setForm({ ...form, total_servings: e.target.value })} />
            </div>
            <div className="sm:col-span-2 space-y-2">
          ...
          <DialogFooter>
            ...
            <Button onClick={submit} disabled={!form.name.trim() || savePlan.isPending}>Save plan</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
    </div>
